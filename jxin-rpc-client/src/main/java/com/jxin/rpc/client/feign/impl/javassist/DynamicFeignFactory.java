package com.jxin.rpc.client.feign.impl.javassist;

import com.jxin.rpc.client.call.Sender;
import com.jxin.rpc.client.call.SenderSub;
import com.jxin.rpc.client.exc.InitFeignExc;
import com.jxin.rpc.client.feign.FeignFactory;
import com.jxin.rpc.client.proxy.impl.cglib.FeignProxy;
...
public class DynamicFeignFactory implements FeignFactory {
    /**实现类的包路径*/
    private static final String INSTANCE_CLASS_PKG_PATH = "com.jxin.rpc.client.feign.instance";
    @Override
